                    ...
                    <div class="dropdown d-flex">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                            <a class="dropdown-item" href="#"><img class="w20 mr-2"
                                    src="https://nsdbytes.com/template/soccer/assets/images/flags/us.svg" />English</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="#"><img class="w20 mr-2"
                                    src="https://nsdbytes.com/template/soccer/assets/images/flags/es.svg" />Spanish</a>
                            <a class="dropdown-item" href="#"><img class="w20 mr-2"
                                    src="https://nsdbytes.com/template/soccer/assets/images/flags/jp.svg" />japanese</a>
                            <a class="dropdown-item" href="#"><img class="w20 mr-2"
                                    src="https://nsdbytes.com/template/soccer/assets/images/flags/bl.svg" />France</a>
                        </div>
                    </div>
                    <div class="dropdown d-flex">
                        <a class="nav-link icon d-none d-md-flex btn btn-default btn-icon ml-2"
                            ...
                            <ul class="list-unstyled feeds_widget">
                                ...
                                <li>
                                    ...
                                    <div class="feeds-body">
                                        <h4 class="title">
                                            New User
                                            <small class="float-right text-muted">10:45</small>
                                        </h4>
                                ...
                                <li>
                                    ...
                                    <div class="feeds-body">
                                        ...
                                        <small>It will give a smart finishing to your
                                            site</small>
                                    </div>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <div class="feeds-body">
                                        <h4 class="title">
                                            7 New Orders
                                            <small class="float-right text-muted">11:35</small>
                                        </h4>
                    ...
                    <div class="dropdown d-flex">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                            ...
                            <a class="dropdown-item" href="app-setting.html"><i
                                    class="dropdown-icon fa fa-settings"></i>
                                Settings</a>
                            <a class="dropdown-item" href="javascript:void(0)"><span class="float-right"><span
                                        class="badge badge-primary">6</span></span><i
                                    class="dropdown-icon fa fa-mail"></i> Inbox</a>
                            <a class="dropdown-item" href="javascript:void(0)"><i
                                    class="dropdown-icon fa fa-send"></i> Message</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="javascript:void(0)"><i
                                    class="dropdown-icon fa fa-help-circle"></i> Need
                                help?</a>
                            <a class="dropdown-item" href="login.html"><i class="dropdown-icon fa fa-log-out"></i>
                                Sign out</a>
                        </div>
                    </div>
                </div>
