    ...
    <div class="container">
        <div class="hleft">
            ...
            <div class="dropdown">
                ...
                <a href="#" class="nav-link icon xs-hide"><i class="fa fa-search"></i></a>
                <a href="#" class="nav-link icon app_inbox xs-hide"><i class="fa fa-calendar"></i></a>
                ...
                <a href="javascript:void(0)" class="nav-link icon theme_btn xs-hide"><i class="fa fa-paint-brush"
